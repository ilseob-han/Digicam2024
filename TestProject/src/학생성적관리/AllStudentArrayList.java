...
//	}return i}
	...
	public static void main(String[] args) {
		...
		StudentScoreHasA[] stu = new StudentScoreHasA[100]; // 행렬삭제 예정
		...
		do {
			...
			case 1:
				...
				StudentProcess.add(addStu);
				StudentProcess.print(accStu + addStu);
				
				

				for (
					int i = accStu; i < accStu + addStu; i++) { // 추가할 할생수 만큼 학생 생성
